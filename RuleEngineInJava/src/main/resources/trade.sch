   ...
   <rule context="Header">
    ...
    <rule context="Trade">
      ...
      <rule context="//TradeDate">
        ...
        <assert test="$hour>=0 and $hour&lt;=23 and string-length(translate(substring(.,12,2),'0123456789',''))=0">The hour must be a value between 0 and 23.</assert>
        <assert test="$minute>=0 and $minute&lt;=59 and string-length(translate(substring(.,15,2),'0123456789',''))=0">The minutes must be a value between 0 and 59.</assert>
        <assert test="$second>=0 and $second&lt;=59 and string-length(translate(substring(.,18,2),'0123456789',''))=0">The second must be a value between 0 and 59.</assert>
